...
##### 이진 트리와 탐색 트리(Binary Search Tree)
...
![캡처9](https://user-images.githubusercontent.com/58559786/91430598-1e595500-e89a-11ea-8014-b07bbb26cf1a.PNG)
...
- 위의 기법을 적용한 해쉬 테이블 코드에 키 생성 함수를 SHA256 해쉬 알고리즘을 사용하도록 변경해보기
