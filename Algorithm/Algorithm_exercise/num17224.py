...
# 문제
# 2019년 올해도 어김없이 아주대학교 프로그래밍 경시대회(Ajou Programming Contest, APC)가 열렸다! 
# 올해 새롭게 APC의 총감독을 맡게 된 준표는 대회 출제 과정 중 큰 고민에 빠졌다. 
...
# 하지만 이 소망은 여태까지 단 한 번도, 그리고 앞으로도 이루어질 리 없기 때문에 현정이가 입버릇처럼 하게 된 말이 있는데...
...
## 해당 문제는 집중력이 떨어진 상태에서 풀어 강의를 듣고 해답은 적었으나 해답조차 이해를 하지 못함.
## 추후 집중력을 되찾을 경우 다시 공부가 필요함
