...
# 이들은 기존의 가위바위보에 질린 나머지, 2개의 손을 모두 이용하여 가위바위보를 즐기는 경지에 이르렀다.
...
# 출력
# 첫 번째 줄에 민성이가 무조건 이길 수 있다면 “MS”, 태경이가 무조건 이길 수 있다면 “TK”, 
...
# 예제 출력 1 
# ?
# 민성이는 왼손에 바위와 오른손에 가위를, 태경이는 왼손에 보와 오른손에 바위를 냈다. 
...
# 0이 2를 이기고, 1이 0을 이기고, 2는 1을 이기는 로직을 어떻게 풀어가야 할 지 생각하여 문제를 해결하면 된다.